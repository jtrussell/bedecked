...
var showRmThemeHelp = function() {
  console.log('');
  console.log('  Unregisters a previsouly registered theme. You cannot unregisters a');
...
var showRmTransitionHelp = function() {
  console.log('');
  console.log('  Unregisters a previsouly registered transition. You cannot unregisters a');
